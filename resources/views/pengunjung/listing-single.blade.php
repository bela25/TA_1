  	...
  	<div class="row">
          ...
          @endif
            ...
            <div class="alert alert-light w-100" role="alert">
              <p>Untuk <strong>Chatting</strong>, Harap login terlebih dahulu.</p>
              <p><a href="{{route('pengunjung.login')}}" class="btn btn-primary py-3 px-5"><i class="fas fa-comments"></i> Chatting</a></p>
            </div>
            @endif
