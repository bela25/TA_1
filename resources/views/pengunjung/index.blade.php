    	...
    	<div class="col-md-4">
    		<div class="property-wrap ftco-animate">
    			...
    			<div class="text">
    				...
    				<h3 class="mb-0"><a href="{{route('pengunjung.listing.single')}}">Blue View Home</a></h3>
...
<section class="ftco-section ftco-fullwidth">
	...
	<div class="container-fluid px-0">
		<div class="row d-md-flex text-wrapper align-items-stretch">
			<div class="one-half mb-md-0 mb-4 img d-flex align-self-stretch" style="background-image: url('{{asset('web/images/about.jpg')}}');"></div>
...
<section class="ftco-section">
    ...
    <div class="row">
      @for($i = 0; $i < 6; $i++)
    	<div class="col-md-4">
    		<div class="listing-wrap img rounded d-flex align-items-end" style="background-image: url('{{asset('web/images/listing-1.jpg')}}');">
    			<div class="location">
    ...
    <div class="row">
      @for($i = 0; $i < 4; $i++)
    	<div class="col-md-3 ftco-animate">
    		<div class="agent">
					<div class="img">
    				<img src="{{asset('web/images/team-1.jpg')}}" class="img-fluid" alt="Colorlib Template">
  				</div>
  				<div class="desc">
  ...
  <div class="container">
    ...
    <div class="row d-flex">
      <div class="col-md-3 d-flex ftco-animate">
          ...
          <div class="text">
          	<a href="blog-single.html" class="block-20 img" style="background-image: url('{{asset('web/images/image_1.jpg')}}');">
            </a>
      ...
      <div class="col-md-3 d-flex ftco-animate">
      	<div class="blog-entry justify-content-end">
          <div class="text">
          	<a href="blog-single.html" class="block-20 img" style="background-image: url('{{asset('web/images/image_2.jpg')}}');">
            </a>
            <h3 class="heading"><a href="#">Why Lead Generation is Key for Business Growth</a></h3>
            <div class="meta mb-3">
              <div><a href="#">October 17, 2019</a></div>
