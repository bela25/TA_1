              ...
              <form role="form" action="{{route('customers.store')}}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="username" placeholder="usernama" name="username">
                   <div class="form-group">
                   ...
                   <div class="form-group">
                    <label>Gender</label>
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="lakilaki" name="customRadio" value="laki-laki">
